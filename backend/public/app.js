...
const WEBSITE_PRODUCT_TYPES = {
  ...
  'Wearables': ['Slippers & Footwear', 'Socks', 'Scarves', 'Shorts & Bottoms', 'T-Shirts', 'Polo Shirts', 'Hoodies & Sweatshirts', 'Sweaters & Knitwear', 'Jackets & Outerwear', 'Hats & Caps', 'Aprons & Uniforms', 'Activewear'],
  'Office & Stationery': ['Notebooks & Journals', 'Pens & Writing', 'Desk Accessories & Organizers', 'Sticky Notes', 'Calendars & Planners', 'Mouse Pads'],
  'Outdoor & Leisure': ['Golf Accessories', 'Camping & Hiking Gear', 'Picnic & BBQ', 'Beach Accessories', 'Fishing Gear', 'Outdoor Games', 'Blankets & Towels', 'Travel & Leisure Kits'],
  ...
  'Gifts & Seasonal': ['Holiday Decorations', 'Gift Wrap & Packaging'],
